...
- operator email inside a thinking_delta: `orionriver@gmail.com` (a NEW disclosure — public commits are authored as mudbungie@gmail.com)
- local paths: `cwd` = `/tmp/claude-1000/-home-mark-dev-lernie/<uuid>/scratchpad`, `memory_paths.auto` = `/home/mark/.claude/projects/...`
