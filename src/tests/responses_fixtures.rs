...
const BASIC: &[u8] = include_bytes!("../../tests/fixtures/openai_responses_basic.sse");
const TOOLS: &[u8] = include_bytes!("../../tests/fixtures/openai_responses_tools.sse");
const MULTIPART: &[u8] = include_bytes!("../../tests/fixtures/openai_responses_multipart.sse");
