...
use crate::{ContentKind, Event, FinishReason, Role, Usage};
...
fn ollama_nonstream_folds_text_tool_usage_and_finish() {
    ...
    let body = include_bytes!("../../tests/fixtures/ollama_chat_nonstream.json");
...
fn google_nonstream_folds_text_tool_and_finish() {
    ...
    let body = include_bytes!("../../tests/fixtures/google_genai_nonstream.json");
