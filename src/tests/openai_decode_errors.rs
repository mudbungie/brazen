...
const ERR_401: &[u8] = include_bytes!("../../tests/fixtures/openai_error_401.json");
const ERR_4XX: &[u8] = include_bytes!("../../tests/fixtures/openai_error_4xx.json");
const ERR_5XX: &[u8] = include_bytes!("../../tests/fixtures/openai_error_5xx.json");
