...
- Auto-install bz locally when main advances [bl-02d6]
- Bump anyhow past RUSTSEC-2026-0190 (cargo audit gate) [bl-75d9]
- add --list-providers: read the EFFECTIVE provider table [bl-b679]
- Fix provider-row parsing under unlocked cargo install dependencies [bl-50af]
- live_conformance raw-projection is invalid for contents-based dialects (google, ollama) [bl-5f6e]
