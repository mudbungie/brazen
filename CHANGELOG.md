...
- bz cannot borrow the Codex CLI's sign-in: the openai-chatgpt row has no ambient source, so a stale bz --login token refuses every ChatGPT request while codex itself is signed in [bl-ee04]
