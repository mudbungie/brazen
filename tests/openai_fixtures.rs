...
const BASIC: &[u8] = include_bytes!("fixtures/openai_chat_basic.sse");
const USAGE: &[u8] = include_bytes!("fixtures/openai_chat_usage.sse");
const TOOLS: &[u8] = include_bytes!("fixtures/openai_chat_tools.sse");
const REFUSAL_FILTER: &[u8] = include_bytes!("fixtures/openai_chat_refusal_filter.sse");
const REFUSAL_FIELD: &[u8] = include_bytes!("fixtures/openai_chat_refusal_field.sse");
const OTHER_FINISH: &[u8] = include_bytes!("fixtures/openai_chat_other_finish.sse");
